...
export default function (app, db) {
  ...
  app.get('/api/v1/projects', function (req, res) {
      db.query("SELECT DISTINCT project FROM sites s LEFT JOIN projects_permissions pp ON s.project=pp.project WHERE project !='CABO-test' ORDER BY project;", { type: db.QueryTypes.SELECT }).then(result => {
        res.send(result);
      })
  }),
